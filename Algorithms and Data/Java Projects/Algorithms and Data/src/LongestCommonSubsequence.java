    ...
    public static void main(String args[]) {
        ...
        while (testBag.getCurrentSize() > 0) {
            ...
            if (strTest.length() > strBestSubsequence.length()) {
                ...
                /* TODO (4): Change this line to test if the string is a subsequence of the second string */
                if (isSubsequence(strTest, strSecond)) {
                    ...
                    System.out.println("Found a subsequence" + strTest);
                    ...
                    if (strTest.length() - 1 > strBestSubsequence.length()) {
                        for (int i = 0; i < strTest.length(); i++) {
                            String strNew = strTest.substring(0, i) + strTest.substring(i + 1);
